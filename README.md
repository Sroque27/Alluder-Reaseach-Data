...
1. Input Stage: User provides a segment of dramatic text
...
3. Enrichment Stage: External APIs (e.g., Wikipedia/Wikidata) are used to retrieve contextual information

4. Output Stage: Results are formatted and returned to the user
...
Table: Baseline Results (No Caching)

| Input Size | Total Time (s) | Entity Enrichment (s)| spaCy (s) | 
|------------|:--------------:|---------------------:|-----------|
| Short      | 14.68          | 14.37                | 0.02      |
| Medium     | 22.39          | 22.30                | 0.07      |
| Long       | 117.73         | 117.10               | 0.53      |

Table: Optimized Results (With Caching)

|Input Size | Total Time (s) | Entity Enrichment (s) | Improvement |
|-----------|----------------|-----------------------|-------------|
| Short     | 13.96          | 13.68                 | ~5%         |
| Medium    | 17.76          | 17.67                 | ~21%        |
| Long      | 85.96          | 85.29                 | ~27%        |
